...
public class ChampsLeft extends SequentialCommandGroup{
    public ChampsLeft(DoubleSupplier shootStall, DoubleSupplier driveStall, DoubleSupplier spitStall, Blinkin blinkin, Drivetrain drivetrain, Intake intake, LowerIndex lowerIndex, UpperIndex upperIndex, Flywheel flywheel, Wrist wrist){
        super(
            ...
            new ParallelDeadlineGroup(
                new PIDTurn(drivetrain, 90),//.andThen(new TimedDrive(drivetrain, 1, false, .1)),
