...
public class FenderSloppyBoth extends SequentialCommandGroup{
    public FenderSloppyBoth(Drivetrain drivetrain, Intake intake, LowerIndex lowerIndex, UpperIndex upperIndex, Flywheel flywheel, Wrist wrist){
        super(
            ...
            new ParallelCommandGroup(
                ...
                new TimedFlywheel(flywheel, Flywheel.State.FWD, 3)),
